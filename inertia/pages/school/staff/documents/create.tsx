...
export default function CreateDocumentPage({ staff }: { staff: StaffMember }) {
  ...
  return (
    <>
      <Head title={`Add Document - ${staff.fullName}`} />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <FormField label="File URL" required error={errors.fileUrl}>
                ...
                <p className="text-xs text-gray-500">
                  Enter the path to the uploaded file. File upload integration coming soon.
                </p>
              </FormField>
              ...
              <div className="flex gap-2 pt-4">
                <Button type="submit" disabled={processing}>
                  {processing ? 'Adding...' : 'Add Document'}
                </Button>
...
CreateDocumentPage.layout = (page: ReactElement) => <DashboardLayout>{page}</DashboardLayout>
