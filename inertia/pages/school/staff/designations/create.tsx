...
export default function CreateDesignationPage({ departments }: { departments: Department[] }) {
...
CreateDesignationPage.layout = (page: ReactElement) => <DashboardLayout>{page}</DashboardLayout>
