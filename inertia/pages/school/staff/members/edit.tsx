...
import type { StaffMember, Department, Designation } from '~/types/staff'
  ...
  return (
    <>
      ...
      <div className="max-w-5xl">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Edit Staff Member - {staff.staffMemberId}</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField label="Designation" error={errors.designationId}>
                    <Select
                      ...
                      onValueChange={(value) => setData('designationId', value === 'none' ? '' : value)}
                    >
...
EditStaffPage.layout = (page: ReactElement) => <DashboardLayout>{page}</DashboardLayout>
