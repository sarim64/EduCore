...
export default function EditAcademicYearPage({ academicYear }: { academicYear: AcademicYear }) {
...
EditAcademicYearPage.layout = (page: ReactElement) => <DashboardLayout>{page}</DashboardLayout>
