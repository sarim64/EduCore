...
import type { StaffMember, TeacherAssignment } from '~/types/staff'
  ...
  return (
    <>
      ...
      <div className="max-w-2xl">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Edit Teacher Assignment</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <FormField label="Is Class Teacher" className="font-normal">
                  <Input
                    id="isClassTeacher"
                    type="checkbox"
...
EditTeacherAssignmentPage.layout = (page: ReactElement) => <DashboardLayout>{page}</DashboardLayout>
