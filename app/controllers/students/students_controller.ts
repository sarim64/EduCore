import GetStudent from '#actions/students/student/get_student'
import StoreStudent from '#actions/students/student/store_student'
import UpdateStudent from '#actions/students/student/update_student'
import DeleteStudent from '#actions/students/student/delete_student'
import BulkImportStudents from '#actions/students/student/bulk_import_students'
...
export default class StudentsController {
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('students/edit', { student: new StudentDto(student) })
  }
