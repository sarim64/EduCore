import ListGuardians from '#actions/students/guardian/list_guardians'
import GetGuardian from '#actions/students/guardian/get_guardian'
import StoreGuardian from '#actions/students/guardian/store_guardian'
import UpdateGuardian from '#actions/students/guardian/update_guardian'
import DeleteGuardian from '#actions/students/guardian/delete_guardian'
...
export default class GuardiansController {
  async index({ session, inertia }: HttpContext) {
    ...
    return inertia.render('students/guardians/index', {
  ...
  async create({ inertia, request }: HttpContext) {
    ...
    return inertia.render('students/guardians/create', { studentId: studentId ?? null })
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('students/guardians/edit', {
