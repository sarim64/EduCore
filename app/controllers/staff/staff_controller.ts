...
import GetStaff from '#actions/staff/staff/get_staff'
import StoreStaff from '#actions/staff/staff/store_staff'
import UpdateStaff from '#actions/staff/staff/update_staff'
import LinkStaffUser from '#actions/staff/staff/link_staff_user'
import UnlinkStaffUser from '#actions/staff/staff/unlink_staff_user'
...
export default class StaffController {
  ...
  async show({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('staff/members/show', {
  ...
  async linkUserPage({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('staff/members/link-user', {
      staff: new StaffDto(staff),
      matchedEmailUser,
      users: users.map((u) => ({
        id: u.id,
