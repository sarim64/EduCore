import ListTeacherAssignments from '#actions/staff/teacher_assignment/list_teacher_assignments'
import GetTeacherAssignment from '#actions/staff/teacher_assignment/get_teacher_assignment'
import StoreTeacherAssignment from '#actions/staff/teacher_assignment/store_teacher_assignment'
import UpdateTeacherAssignment from '#actions/staff/teacher_assignment/update_teacher_assignment'
import DeleteTeacherAssignment from '#actions/staff/teacher_assignment/delete_teacher_assignment'
import ListStaff from '#actions/staff/staff/list_staff'
...
import ListSections from '#actions/academics/section/list_sections'
import ListSubjects from '#actions/academics/subject/list_subjects'
...
export default class TeacherAssignmentsController {
  async index({ session, inertia }: HttpContext) {
    ...
    return inertia.render('staff/teacher-assignments/index', {
  ...
  async create({ session, inertia }: HttpContext) {
    ...
    return inertia.render('staff/teacher-assignments/create', {
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('staff/teacher-assignments/edit', {
