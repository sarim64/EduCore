...
import GetDepartment from '#actions/staff/department/get_department'
import StoreDepartment from '#actions/staff/department/store_department'
import UpdateDepartment from '#actions/staff/department/update_department'
import DeleteDepartment from '#actions/staff/department/delete_department'
...
export default class DepartmentsController {
  ...
  async create({ inertia }: HttpContext) {
    return inertia.render('staff/departments/create')
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('staff/departments/edit', {
