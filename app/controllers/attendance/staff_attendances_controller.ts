...
import MarkStaffAttendance from '#actions/attendance/mark_staff_attendance'
import MarkBulkStaffAttendance from '#actions/attendance/mark_bulk_staff_attendance'
...
export default class StaffAttendancesController {
  async index({ session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/staff/index', {
  ...
  async markForm({ session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/staff/mark', {
      staffMembers: StaffDto.fromArray(staffMembers),
    })
  }
  ...
  async bulkMarkForm({ session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/staff/bulk-mark', {
      staffMembers: StaffDto.fromArray(staffMembers),
    })
  }
  ...
  async staffHistory({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/staff/history', {
