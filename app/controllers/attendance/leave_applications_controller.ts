import ListLeaveApplications from '#actions/attendance/list_leave_applications'
import GetLeaveApplication from '#actions/attendance/get_leave_application'
import ApplyLeave from '#actions/attendance/apply_leave'
import ProcessLeaveApplication from '#actions/attendance/process_leave_application'
...
export default class LeaveApplicationsController {
  ...
  async create({ session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/leaves/apply', {
  ...
  async pending({ session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/leaves/pending', {
      applications: LeaveApplicationDto.fromArray(applications),
    })
  }
