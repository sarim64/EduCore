...
export default class AttendanceReportsController {
  ...
  async daily({ request, session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/reports/daily', {
      classes: classesData,
  ...
  async student({ params, request, session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/reports/student', {
      student: {
        id: student.id,
  ...
  async calendar({ request, session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/reports/calendar', {
      classes: classesData,
      selectedClassId: classId || null,
      selectedSectionId: sectionId || null,
      selectedYear: Number(year),
  ...
  async summary({ request, session, inertia }: HttpContext) {
    ...
    return inertia.render('attendance/reports/summary', {
      selectedDate: dateStr,
      studentSummary,
      staffSummary,
    })
