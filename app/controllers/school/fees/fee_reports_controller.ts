...
import FeeCollectionReport from '#actions/school/fees/reports/fee_collection_report'
import DefaultersReport from '#actions/school/fees/reports/defaulters_report'
...
export default class FeeReportsController {
  async collection({ session, request, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/reports/collection', {
  ...
  async defaulters({ session, request, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/reports/defaulters', {
      defaulters,
      summary: report.summary,
      academicYears: AcademicYearDto.fromArray(academicYears),
      classes: SchoolClassDto.fromArray(classes),
