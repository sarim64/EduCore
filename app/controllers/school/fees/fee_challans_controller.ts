...
import ListChallans from '#actions/school/fees/fee_challan/list_challans'
import GetChallan from '#actions/school/fees/fee_challan/get_challan'
import GenerateChallan from '#actions/school/fees/fee_challan/generate_challan'
import BulkGenerateChallans from '#actions/school/fees/fee_challan/bulk_generate_challans'
import ApplyLateFees from '#actions/school/fees/fee_challan/apply_late_fees'
import CancelChallan from '#actions/school/fees/fee_challan/cancel_challan'
...
export default class FeeChallansController {
  async index({ session, request, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/challans/index', {
      challans: {
  ...
  async create({ session, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/challans/create', {
      academicYears: AcademicYearDto.fromArray(academicYears),
      classes: SchoolClassDto.fromArray(classes),
  ...
  async bulkCreate({ session, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/challans/bulk-create', {
      academicYears: AcademicYearDto.fromArray(academicYears),
      classes: SchoolClassDto.fromArray(classes),
    })
  }
  ...
  async show({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/challans/show', {
