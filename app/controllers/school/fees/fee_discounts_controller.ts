...
import GetFeeDiscount from '#actions/school/fees/fee_discount/get_fee_discount'
import StoreFeeDiscount from '#actions/school/fees/fee_discount/store_fee_discount'
import UpdateFeeDiscount from '#actions/school/fees/fee_discount/update_fee_discount'
import DeleteFeeDiscount from '#actions/school/fees/fee_discount/delete_fee_discount'
...
export default class FeeDiscountsController {
  async index({ session, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/discounts/index', {
  ...
  async create({ session, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/discounts/create', {
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/fees/discounts/edit', {
