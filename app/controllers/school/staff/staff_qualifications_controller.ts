...
import StoreStaffQualification from '#actions/school/staff/qualification/store_staff_qualification'
import {
...
export default class StaffQualificationsController {
  async index({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/staff/qualifications/index', {
  ...
  async create({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/staff/qualifications/create', {
      staff: new StaffDto(staff),
    })
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/staff/qualifications/edit', {
      staff: new StaffDto(staff),
