...
import StoreStaffDocument from '#actions/school/staff/document/store_staff_document'
import {
...
export default class StaffDocumentsController {
  async index({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/staff/documents/index', {
  ...
  async create({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/staff/documents/create', {
      staff: new StaffDto(staff),
    })
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('school/staff/documents/edit', {
      staff: new StaffDto(staff),
