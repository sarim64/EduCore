...
import GetSection from '#actions/academics/section/get_section'
import StoreSection from '#actions/academics/section/store_section'
import UpdateSection from '#actions/academics/section/update_section'
import DeleteSection from '#actions/academics/section/delete_section'
...
export default class SectionsController {
  async create({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/sections/create', { schoolClass })
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/sections/edit', { section })
  }
