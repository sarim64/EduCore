...
import GetSubject from '#actions/academics/subject/get_subject'
import StoreSubject from '#actions/academics/subject/store_subject'
import UpdateSubject from '#actions/academics/subject/update_subject'
import DeleteSubject from '#actions/academics/subject/delete_subject'
import AssignSubjectToClass from '#actions/academics/class/assign_subject_to_class'
import RemoveSubjectFromClass from '#actions/academics/class/remove_subject_from_class'
import {
...
export default class SubjectsController {
  async index({ session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/subjects/index', { subjects })
  }
  ...
  async show({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/subjects/show', { subject, allClasses })
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/subjects/edit', { subject })
  }
