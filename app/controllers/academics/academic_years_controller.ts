...
import GetAcademicYear from '#actions/academics/year/get_academic_year'
import StoreAcademicYear from '#actions/academics/year/store_academic_year'
import UpdateAcademicYear from '#actions/academics/year/update_academic_year'
import DeleteAcademicYear from '#actions/academics/year/delete_academic_year'
import SetCurrentAcademicYear from '#actions/academics/year/set_current_academic_year'
...
export default class AcademicYearsController {
  async index({ session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/academic-years/index', { academicYears })
  }

  async create({ inertia }: HttpContext) {
    return inertia.render('academics/academic-years/create')
  }
  ...
  async edit({ params, session, inertia }: HttpContext) {
    ...
    return inertia.render('academics/academic-years/edit', { academicYear })
  }
