...
import ListStudentDiscounts from '#actions/fees/student_discount/list_student_discounts'
import AssignStudentDiscount from '#actions/fees/student_discount/assign_student_discount'
import BulkAssignStudentDiscount from '#actions/fees/student_discount/bulk_assign_student_discount'
import RemoveStudentDiscount from '#actions/fees/student_discount/remove_student_discount'
...
export default class StudentDiscountsController {
  async index({ session, request, inertia }: HttpContext) {
    ...
    return inertia.render('fees/student-discounts/index', {
  ...
  async create({ session, inertia }: HttpContext) {
    ...
    return inertia.render('fees/student-discounts/create', {
